            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ url($form_url) }}">
              ...
              <div class="form-group">
                <div class="col-md-6 col-md-offset-4">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="admin" value="1" {{ old('admin') || $user->admin ? 'checked' : '' }}> Administrator
                        </label>
                    </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-md-8 col-md-offset-4">
                  @if (isset($delete_url) && !$logged_in_user)
                  ...
                  &nbsp;
                  <a class="btn btn-link" href="{{ url('/users') }}">
                    Back
                  </a>
                </div>
              </div>
